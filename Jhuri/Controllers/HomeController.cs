...
namespace Jhuri.Controllers
{
    public class HomeController : Controller
    {
        ...
        public List<CommentListViewModel> GetAllCommentsByProduct(int productId)
        {
            List<CommentListViewModel> commentsList = new List<CommentListViewModel>();
            ...
            {
                CommentListViewModel comments = new CommentListViewModel
                {
